...
export default function MortgageCalculator() {
  ...
  var totalOfAllPayments = (monthlyPaymentsWithPmi * pmiStopMonth) + (monthlyPayments * ((calculatorState.loanTerm * 12) - pmiStopMonth));
  ...
  var loanBreakDownTotal = loanAmount + downPayment + totalInterestPaid + insuranceCondoTotal + taxTotal;
                    ...
                    <div style={{display: "flex", justifyContent: "center", marginBottom: "30px", marginTop: "30px"}}>
                      <PieChart
                        ...
                        data={[
                          ...
                          { title: 'Interest', value: totalInterestPaid, color: '#C13C37' },
                          { title: 'Tax', value: taxTotal, color: '#6A2135' },
                          { title: 'Insurance', value: insuranceCondoTotal, color: '#E38627' },
                          { title: 'Down Payment', value: downPayment, color: '#C13C37' },
                        ]}
                        labelStyle={{
                          fontSize: "8px",
                          fontColor: "FFFFFA",
          ...
          <div className='mort-det-weekly-div'>
            <div className='mortgage-details-div'>
              <div className='mortgage-details-div-inner'>
                ...
                <div className='mortgage-details-flex'>
                  <div>
                    <span>Total PMI to {monthNames[pmiEndDate.getMonth()] + ", " + pmiEndDate.getFullYear()}:</span>
                  </div>
                  ...
                  <div>
                    <div className='mgd-progress-bar' style={{width: pmiTotalPercent + "%"}}>
                      <span className='percentage-progress'>{pmiTotalPercent }%</span>
                    </div>
                  </div>
                </div>
                ...
                <div className='mortgage-details-flex'>
                  ...
                  <div>
                    <span style={{fontWeight: "bold"}}>${numberWithCommas(totalOfAllPayments.toFixed(2))}</span>
                  </div>
            ...
            <div className='weekly-payments-div'>
              <div className='weekly-payments-div-inner'>
                ...
                <div className='mortgage-details-flex'>
                  <div>
                    <div style={{fontWeight: "bold", fontSize: "18px"}}>${numberWithCommas(monthlyPayments.toFixed(2))}</div>
                    <div>Monthly Payment</div>
                  </div>

                  <div>
                    <div style={{fontWeight: "bold", fontSize: "18px"}}>${numberWithCommas((monthlyPayments / 2).toFixed(2))}</div>
