                  ...
                  <div className="field-input-wrapper">
                    ...
                    <input className="bblr-0 btlr-0" type="text" value={calculatorState.homeValue} 
                      onChange={e => {
                        ...
                        newState.homeValue = Number(e.target.value);
                  ...
                  <div className="field-input-wrapper">
                    ...
                    <input className="bblr-0 btlr-0" type="text" value={((calculatorState.homeValue * calculatorState.downPaymentPercent) / 100)}
                      onChange={e => {
                        ...
                        let newState = {...calculatorState}
                        newState.downPaymentPercent = Number((e.target.value * 100) / newState.homeValue);
                        updateCalculatorState(newState);
                      }} />
                  </div>
                </div>
                  ...
                  <div className="field-input-wrapper">
                    <input className="bbrr-0 btrr-0" type="text" value={calculatorState.loanTerm} 
                      onChange={e => {
                        ...
                        let newState = {...calculatorState}
                        newState.loanTerm = Number(e.target.value);
                        updateCalculatorState(newState);
                      }} />
                  ...
                  <div className="field-input-wrapper">
                    <input className="bbrr-0 btrr-0" type="text" value={calculatorState.propertyTax} 
                      onChange={e => {
                        ...
                        let newState = {...calculatorState}
                        newState.propertyTax = Number(e.target.value);
                        updateCalculatorState(newState);
                      }} />
                    <span className="field-unit">$/years</span>
                  </div>
                  ...
                  <div className="field-input-wrapper">
                    <input className="bbrr-0 btrr-0" type="text" value={calculatorState.homeInsurance} 
                      onChange={e => {
                        ...
                        let newState = {...calculatorState}
                        newState.homeInsurance = Number(e.target.value);
                        updateCalculatorState(newState);
                      }} />
                  ...
                  <span className="field-unit">$</span>
                    <input className="bblr-0 btlr-0" type="text" value={calculatorState.monthlyCondoFee} 
                      onChange={e => {
                        ...
                        let newState = {...calculatorState}
                        newState.monthlyCondoFee = Number(e.target.value);
                        updateCalculatorState(newState);
                      }} />
                  </div>
                </div>
