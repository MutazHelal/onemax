                ...
                <div className='sv-calc-wrapper'>
                    <div className='sv-calc-intro-div'>
                        <div className='sv-calc-intro-div-inner'>
                            <h6 className="text-3xl font-bold sm:text-3xl text-dark-blue text-center">How much could you save selling with OneMax?</h6>
                        </div>
                    </div>
                    <div className='sv-calc-form-area'>
                        <h6 className='text-1xl font-bold text-dark-blue text-center' style={{marginBottom: "5px"}}>Slide to select your home's value</h6>
                        <h6 className='text-2xl text-dark-blue text-center'>${numberWithCommas(homeValue)}</h6>
                        ...
                        <div className='sv-calc-home-val-slider-wrapper'>
                            ...
                            <input className="range-slider" type="range" min={minHomeValue} max={maxHomeValue} value={homeValue}
                                onChange={e => {
                        ...
                        <h6 className='text-2xl text-dark-blue text-center' style={{marginBottom: "10px"}}>Your commission savings</h6>

                        <h6 className="text-3xl font-bold sm:text-5xl text-dark-blue text-center" style={{marginBottom: "10px"}}>${numberWithCommas(savingsValue)}*</h6>

                        <p className="pt-5 sm:text-s text-short-title text-center">*When compared to a commission of 5%, taking into account 2.5% buyer agent commission and our 1% listing fee payable when the home successfully sells, plus the applicable taxes.</p>
                    </div>
                </div>
            </div>
        </>
