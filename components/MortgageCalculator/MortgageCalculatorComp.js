...
export default function MortgageCalculatorComp() {
  ...
  const [loanPayOffDateBiWeekly, setLoanPayOffDateBiWeekly] = useState(
    new Date()
  );
  ...
  const updateResults = (calculatorState) => {
    var downPayment =
      (calculatorState.homeValue * calculatorState.downPaymentPercent) / 100;
    ...
    let biWeeklyInterestRate = getMonthlyInterestRate(
    ...
    const d = new Date();
    d.setFullYear(
      calculatorState.startDate.year,
      calculatorState.startDate.month - 1,
      1
    );

    let pmiStopMonth = getPmiStopMonth(
      calculatorState.homeValue,
      Pir,
      loanAmount,
      mp
    );
    let [amortizationSchedule1, totalInterest, totalMonths] =
      calculateAmortizationSchedule(Pir, loanAmount, mp, new Date(d));
    let [totalInterestBiWeekly, totalBiWeeks] = getBiWeeklyPaymentsDetails(
    ...
    var biWeeklyPayOffDate = new Date(
      d3.setDate(d3.getDate() + totalBiWeeks * 7)
    );
  ...
  const calculateAmortizationSchedule = (
    ...
    while (loanAmount > 0) {
      ...
      if (date.getFullYear() != year || loanAmount == 0) {
        table.push([year, monthResults.i, monthResults.p, loanAmount]);
  ...
  const getBiWeeklyPaymentsDetails = (
    biWeeklyInterestRate,
    loanAmount,
    biWeeklyPayment
  ) => {
  ...
  const getMonthlyInterestRate = (interestRate, frequency = "monthly") => {
    ...
    if (frequency == "monthly") powerB = 1 / 12;
    else if (frequency == "bi-weekly") powerB = 14 / 365;
  ...
  var pmiTotal = pmiStopMonth * monthlyPmi;
  var taxTotal = calculatorState.loanTerm * calculatorState.propertyTax;
  var insuranceCondoTotal =
    calculatorState.loanTerm *
    (calculatorState.homeInsurance + calculatorState.monthlyCondoFee);
  var totalOfAllPayments =
    monthlyPaymentsWithPmi * pmiStopMonth +
    monthlyPayments * (calculatorState.loanTerm * 12 - pmiStopMonth);
  var loanPayOffDateStr =
    monthNames[loanPayOffDate.getMonth()] + ", " + loanPayOffDate.getFullYear();
  var biWeeklyLoanPayOffDateStr =
    monthNames[loanPayOffDateBiWeekly.getMonth()] +
    ", " +
    loanPayOffDateBiWeekly.getFullYear();

  var loanAmountPercent = ((loanAmount * 100) / totalOfAllPayments).toFixed(2);
  var downPaymentPercent = ((downPayment * 100) / totalOfAllPayments).toFixed(
    2
  );
  var totalInterestPaidPercent = (
    (totalInterestPaid * 100) /
    totalOfAllPayments
  ).toFixed(2);
  var pmiTotalPercent = ((pmiTotal * 100) / totalOfAllPayments).toFixed(2);
  var taxTotalPercent = ((taxTotal * 100) / totalOfAllPayments).toFixed(2);
  var insuranceCondoTotalPercent = (
    (insuranceCondoTotal * 100) /
    totalOfAllPayments
  ).toFixed(2);
        ...
        <div className="mg-calc-inner">
          <div className="mg-calc-centered">
            <div className="mg-calc-centered-inner">
              <h6 className="text-4xl font-bold sm:text-5xl text-dark-blue text-center">
                How Much House Can You Afford?
              </h6>
              <p className="pt-5 sm:text-xl text-short-title text-center">
                This mortgage calculator can be used to figure out monthly
                payments of a home mortgage loan, based on the homes sale price,
                the term of the loan desired, buyers down payment percentage,and
              ...
              <form className="mg-calc-form">
                <div className="field-group">
                  ...
                  <div className="field-input-wrapper">
                    ...
                    <input
                      className="bblr-0 btlr-0"
                      type="text"
                      value={numberWithCommas(calculatorState.homeValue)}
                      onChange={(e) => {
                  ...
                  <div className="field-input-wrapper">
                    ...
                    <input
                      ...
                      value={numberWithCommas(
                        (calculatorState.homeValue *
                          calculatorState.downPaymentPercent) /
                          100
                      )}
                      onChange={(e) => {
                        if (isNaN(Number(e.target.value.replaceAll(",", "")))) {
                        ...
                        let newState = { ...calculatorState };
                        newState.downPaymentPercent = Number(
                          (Number(e.target.value.replaceAll(",", "")) * 100) /
                            newState.homeValue
                        );
                        updateCalculatorState(newState);
                      }}
                ...
                <input
                  ...
                  min="0"
                  max="100"
                  value={calculatorState.downPaymentPercent}
                  onChange={(e) => {
                ...
                <div className="field-group">
                  ...
                  <div className="field-input-wrapper">
                    <input
                      className="bbrr-0 btrr-0"
                      type="text"
                      value={numberWithCommas(calculatorState.interestRate)}
                      onChange={(e) => {
                        if (isNaN(Number(e.target.value.replaceAll(",", "")))) {
                          return;
                        }
                ...
                <div className="field-group">
                  ...
                  <div className="field-input-wrapper">
                    <input
                      className="bbrr-0 btrr-0"
                      type="text"
                      value={calculatorState.loanTerm}
                      onChange={(e) => {
                        if (isNaN(Number(e.target.value.replaceAll(",", "")))) {
                          return;
                        }
                ...
                <div className="field-group">
                  ...
                  <div className="field-input-wrapper">
                    ...
                    <input
                      className="bblr-0 btlr-0"
                      type="text"
                      value={calculatorState.startDate.year}
                      onChange={(e) => {
                        if (isNaN(Number(e.target.value))) {
                          return;
                        }
                ...
                <div className="field-group">
                  ...
                  <div className="field-input-wrapper">
                    <input
                      className="bbrr-0 btrr-0"
                      type="text"
                      value={numberWithCommas(calculatorState.propertyTax)}
                      onChange={(e) => {
                        if (isNaN(Number(e.target.value.replaceAll(",", "")))) {
                          return;
                        }
                ...
                <div className="field-group">
                  ...
                  <div className="field-input-wrapper">
                    <input
                      className="bbrr-0 btrr-0"
                      type="text"
                      value={numberWithCommas(calculatorState.pmiPercent)}
                      onChange={(e) => {
                        if (isNaN(Number(e.target.value.replaceAll(",", "")))) {
                          return;
                        }
                        ...
                        let newState = { ...calculatorState };
                        newState.pmiPercent = e.target.value.replaceAll(
                          ",",
                          ""
                        );
                        updateCalculatorState(newState);
                ...
                <input
                  ...
                  max="10"
                  step={0.01}
                  value={calculatorState.pmiPercent}
                  onChange={(e) => {
                    if (isNaN(Number(e.target.value))) {
                      return;
                    }
                ...
                <div className="field-group">
                  ...
                  <div className="field-input-wrapper">
                    <input
                      className="bbrr-0 btrr-0"
                      type="text"
                      value={numberWithCommas(calculatorState.homeInsurance)}
                      onChange={(e) => {
                        if (isNaN(Number(e.target.value.replaceAll(",", "")))) {
                          return;
                        }
                ...
                <div className="field-group">
                  ...
                  <div className="field-input-wrapper">
                    ...
                    <input
                      className="bblr-0 btlr-0"
                      type="text"
                      value={numberWithCommas(calculatorState.monthlyCondoFee)}
                      onChange={(e) => {
                        if (isNaN(Number(e.target.value.replaceAll(",", "")))) {
                          return;
                        }
                        ...
                        let newState = { ...calculatorState };
                        newState.monthlyCondoFee = Number(
                          e.target.value.replaceAll(",", "")
                        );
                        updateCalculatorState(newState);
                      }}
              ...
              <div className="mg-calc-loan-card">
                <div>
                  <h2 className="text-3xl font-bold text-dark-blue">
                    ${numberWithCommas(monthlyPaymentsWithPmi.toFixed(2))}
                  </h2>
                  <span style={{ fontSize: "14px" }}>
                    Your estimated monthly payment{" "}
                    {calculatorState.pmiPercent > 0 ? "with PMI" : ""}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <div className="field-group">
                    ...
                    <div>
                      <span>
                        $
                        {numberWithCommas(
                          (calculatorState.propertyTax / 12).toFixed(2)
                        )}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="field-group">
                    ...
                    <div>
                      <span>
                        $
                        {numberWithCommas(
                          (calculatorState.homeInsurance / 12).toFixed(2)
                        )}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="field-group">
                    ...
                    <div>
                      <span>
                        $
                        {numberWithCommas(
                          calculatorState.monthlyCondoFee.toFixed(2)
                        )}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="field-group">
                    ...
                    <div>
                      <span>
                        {monthNames[pmiEndDate.getMonth()] +
                          ", " +
                          pmiEndDate.getFullYear()}
                      </span>
                    </div>
                  </div>
                  ...
                  <div>
                    <h2
                      ...
                      className="text-1xl font-bold text-dark-blue"
                    >
                      Loan Breakdown
                    </h2>
                    ...
                    >
                      <PieChart
                        ...
                        data={[
                          {
                            title: loanAmount != 0 ? "Principal" : "",
                            value: loanAmount,
                            color: "#E38627",
                          },
                          {
                            title: totalInterestPaid != 0 ? "Interest" : "",
                            value: totalInterestPaid,
                            color: "#C13C37",
                          },
                          {
                            title: taxTotal != 0 ? "Tax" : "",
                            value: taxTotal,
                            color: "#6A2135",
                          },
                          {
                            title: insuranceCondoTotal != 0 ? "Insurance" : "",
                            value: insuranceCondoTotal,
                            color: "#E38627",
                          },
                          {
                            title: downPayment != 0 ? "Down Payment" : "",
                            value: downPayment,
                            color: "#C13C37",
                          },
                        ]}
            ...
            <div className="mortgage-details-div">
              <div className="mortgage-details-div-inner">
                ...
                <div className="mortgage-details-flex">
                  ...
                  <div>
                    <span>
                      ${numberWithCommas(downPayment.toFixed(2))} (
                      {calculatorState.downPaymentPercent.toFixed(2)}%)
                    </span>
                  </div>
                ...
                <div className="mortgage-details-flex">
                  ...
                  <div>
                    <span>
                      ${numberWithCommas(totalInterestPaid.toFixed(2))}
                    </span>
                  </div>
                  ...
                  <div>
                    <div
                      className="mgd-progress-bar"
                      style={{ width: totalInterestPaidPercent + "%" }}
                    >
                      <span className="percentage-progress">
                        {totalInterestPaidPercent}%
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mortgage-details-flex">
                  ...
                  <div>
                    <span>${numberWithCommas(pmiTotal.toFixed(2))}</span>
                  </div>

                  <div>
                    <div
                      className="mgd-progress-bar"
                      style={{ width: pmiTotalPercent + "%" }}
                    >
                      <span className="percentage-progress">
                        {pmiTotalPercent}%
                      </span>
                ...
                <div className="mortgage-details-flex">
                  ...
                  <div>
                    <span>
                      ${numberWithCommas(insuranceCondoTotal.toFixed(2))}
                    </span>
                  </div>
                  ...
                  <div>
                    <div
                      className="mgd-progress-bar"
                      style={{ width: insuranceCondoTotalPercent + "%" }}
                    >
                      <span className="percentage-progress">
                        {insuranceCondoTotalPercent}%
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mortgage-details-flex">
                  <div>
                    <span>
                      Total of {calculatorState.loanTerm * 12} payments:
                    </span>
                  </div>

                  <div>
                    <span style={{ fontWeight: "bold" }}>
                      ${numberWithCommas(totalOfAllPayments.toFixed(2))}
                    </span>
                  </div>
            ...
            <div className="weekly-payments-div">
              <div className="weekly-payments-div-inner">
                ...
                <div className="mortgage-details-flex">
                  ...
                  <div>
                    <div style={{ fontWeight: "bold", fontSize: "18px" }}>
                      ${numberWithCommas((monthlyPayments / 2).toFixed(2))}
                    </div>
                ...
                <div className="mortgage-details-flex">
                  ...
                  <div>
                    <div style={{ fontWeight: "bold", fontSize: "18px" }}>
                      ${numberWithCommas(totalInterestBiWeekly.toFixed(2))}
                    </div>
                    <div>Total Interest Paid</div>
                  </div>
                </div>
                ...
                <div style={{ textAlign: "center", marginTop: "20px" }}>
                  ...
                  {numberWithCommas(
                    (totalInterestPaid - totalInterestBiWeekly).toFixed(2)
                  )}
                </div>
              </div>
            </div>
